...
var collection;
var _a = process.env, MONGO_SECRET = _a.MONGO_SECRET, DB = _a.DB, COLLECTION = _a.COLLECTION, SCRAPE_LINK = _a.SCRAPE_LINK;
...
exports.handler = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, obj;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                _a.label = 2;
            case 2: return [4, axios_1["default"].get(SCRAPE_LINK)];
            case 3:
                data = (_a.sent()).data;
                obj = __assign(__assign({}, data), { date: new Date() });
